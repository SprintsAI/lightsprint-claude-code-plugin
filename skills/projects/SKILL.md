---
name: projects
description: List projects from the active Lightsprint (ls) workspace. Use when you need to see available projects or find a project ID for filtering tasks.
---
...
- Projects are workspace-scoped — they may contain tasks from multiple stacks/repos within the workspace
